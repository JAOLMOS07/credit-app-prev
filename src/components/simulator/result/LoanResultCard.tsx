    ...
    return (
        <div className="relative bg-white border border-gray-200 rounded-2xl p-6 space-y-6 shadow-lg">
            ...
            <div className="text-center space-y-1">
                <h3 className="text-lg font-medium text-slate-700">Resultado de tu préstamo</h3>
            ...
            <div className="text-center">
                <p className="text-sm text-slate-500">Pago total</p>
                <p className="text-2xl font-semibold text-slate-800">${totalCost.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
